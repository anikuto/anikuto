...
class InitSchema < ActiveRecord::Migration[5.1]
  def up
    ...
    create_table 'channel_works', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at'
      t.datetime 'updated_at'
      t.index %w(user_id work_id channel_id), name: 'index_channel_works_on_user_id_and_work_id_and_channel_id',
                                              unique: true
      t.index %w(user_id work_id), name: 'index_channel_works_on_user_id_and_work_id'
    end
    ...
    create_table 'characters', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(name kind), name: 'index_characters_on_name_and_kind', unique: true
    end
    ...
    create_table 'db_activities', id: :serial, force: :cascade do |t|
      ...
      t.index %w(object_id object_type), name: 'index_db_activities_on_object_id_and_object_type'
      t.index %w(root_resource_id root_resource_type), name: 'index_db_activities_on_root_resource_id_and_root_resource_type'
      t.index %w(trackable_id trackable_type), name: 'index_db_activities_on_trackable_id_and_trackable_type'
    end
    create_table 'db_comments', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(resource_id resource_type), name: 'index_db_comments_on_resource_id_and_resource_type'
    ...
    create_table 'draft_staffs', id: :serial, force: :cascade do |t|
      ...
      t.index %w(resource_id resource_type), name: 'index_draft_staffs_on_resource_id_and_resource_type'
    ...
    create_table 'edit_request_participants', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(edit_request_id user_id), name: 'index_edit_request_participants_on_edit_request_id_and_user_id',
                                           unique: true
    ...
    create_table 'edit_requests', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(draft_resource_id draft_resource_type), name: 'index_er_on_drid_and_drtype'
    ...
    create_table 'episodes', id: :serial, force: :cascade do |t|
      ...
      t.index %w(work_id sc_count), name: 'index_episodes_on_work_id_and_sc_count', unique: true
    end
    create_table 'finished_tips', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(user_id tip_id), name: 'index_finished_tips_on_user_id_and_tip_id', unique: true
    end
    create_table 'follows', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at'
      t.datetime 'updated_at'
      t.index %w(user_id following_id), name: 'index_follows_on_user_id_and_following_id', unique: true
    end
    ...
    create_table 'latest_statuses', id: :serial, force: :cascade do |t|
      ...
      t.index %w(user_id position), name: 'index_latest_statuses_on_user_id_and_position'
      t.index %w(user_id work_id), name: 'index_latest_statuses_on_user_id_and_work_id', unique: true
    ...
    create_table 'likes', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at'
      t.datetime 'updated_at'
      t.index %w(recipient_id recipient_type), name: 'index_likes_on_recipient_id_and_recipient_type'
    end
    ...
    create_table 'mute_users', id: :serial, force: :cascade do |t|
      ...
      t.index %w(user_id muted_user_id), name: 'index_mute_users_on_user_id_and_muted_user_id', unique: true
    ...
    create_table 'notifications', id: :serial, force: :cascade do |t|
      ...
      t.index %w(trackable_id trackable_type), name: 'index_notifications_on_trackable_id_and_trackable_type'
    end
    ...
    create_table 'providers', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at'
      t.datetime 'updated_at'
      t.index %w(name uid), name: 'index_providers_on_name_and_uid', unique: true
    end
    create_table 'receptions', id: :serial, force: :cascade do |t|
      ...
      t.datetime 'created_at'
      t.datetime 'updated_at'
      t.index %w(user_id channel_id), name: 'index_receptions_on_user_id_and_channel_id', unique: true
    end
    create_table 'seasons', id: :serial, force: :cascade do |t|
      ...
      t.index %w(year name), name: 'index_seasons_on_year_and_name', unique: true
    ...
    create_table 'staffs', id: :serial, force: :cascade do |t|
      ...
      t.index %w(resource_id resource_type), name: 'index_staffs_on_resource_id_and_resource_type'
