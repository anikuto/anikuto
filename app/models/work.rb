...
class Work < ApplicationRecord
  ...
  scope :gt_current_season, -> {
    season = Season.find_by_slug(ENV.fetch('ANIKUTO_CURRENT_SEASON'))
  ...
  def current_season?
    season.present? && season.slug == ENV['ANIKUTO_CURRENT_SEASON']
  end

  def next_season?
    season.present? && season.slug == ENV['ANIKUTO_NEXT_SEASON']
  end
